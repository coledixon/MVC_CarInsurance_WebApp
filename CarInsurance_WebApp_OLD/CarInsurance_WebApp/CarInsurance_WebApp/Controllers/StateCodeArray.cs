...
{
    public class StateCodeArray
    {
        static List<US_State> states = new List<US_State>(50);

        static StateCodeArray()
        {
        ...
        public static string[] Names()
        {
            ...
            foreach (var state in states)
            {
                nameList.Add(state.Name.ToLower());
            }
    ...
    public class US_State
    {
        ...
        public US_State(string _abbr, string name)
        {
            Name = name;
            Abbr = _abbr;
        }
        ...
        {
            return string.Format("{0} - {1}", Abbr, Name);
        }
    }
}